...
namespace Backtrace
{
    ...
    public class BacktraceDatabase : IBacktraceDatabase
    {
        ...
        /// </summary>
        public BacktraceDatabaseRecord Add(BacktraceReportBase backtraceReport, Dictionary<string, object> attributes, MiniDumpType miniDumpType = MiniDumpType.Normal)
        {
            if (!_enable)
            {
                return null;
