...
namespace Backtrace.Model.JsonData
{
    ...
    public class DiagnosticStack
    {
        ...
        internal static DiagnosticStack Convert(StackFrame stackFrame, string libraryName, bool generatedByException = false)
        {
            if (stackFrame == null)
            {
                return null;
        ...
        internal static List<DiagnosticStack> Convert(Exception exception)
        {
            ...
            {
                return new List<DiagnosticStack>();
            }
            // convert from stacktrace to diagnostic stack trace
            return stackFrames.Select(n => Convert(n, source, true)).ToList();
        }
#if NET45
        internal static IEnumerable<DiagnosticStack> Convert(IEnumerable<ClrStackFrame> clrStackFrames)
        {
            var result = new List<DiagnosticStack>();
            ...
            foreach (var clrStackFrame in clrStackFrames)
            {
                ...
                result.Add(new DiagnosticStack()
                {
